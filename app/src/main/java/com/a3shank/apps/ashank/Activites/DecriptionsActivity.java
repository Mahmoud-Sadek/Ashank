...
public class DecriptionsActivity extends AppCompatActivity implements BaseSliderView.OnSliderClickListener, ViewPagerEx.OnPageChangeListener,
...
//        myTypeface = Typeface.createFromAsset(getBaseContext().getAssets(), "arabic2.otf");
        ...
        qmyItemsClientDatabase = myItemsClientDatabase.orderByKey().startAt(model.getClientId());
