...
//Do some magic
//                qmySearchedDatabase = myClientsDatabase.getRef().orderByChild("firstName").startAt(query);
...
//                    FoldingCellListAdapter adapters = new FoldingCellListAdapter(activity, clientList);
